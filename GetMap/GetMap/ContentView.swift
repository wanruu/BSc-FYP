...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            loadTasks.filter{$0 == true}.count != loadTasks.count ? nil : MainPage(locations: $locations, trajectories: $trajectories, lineSegments: $lineSegments, representatives: $representatives, p: $p)
        }
